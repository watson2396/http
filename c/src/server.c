...
int parse_message_headers()
{
    ...
    ret_result = chtbl_init(headers, 10, hashpjw, match, chtbl_destroy);
...
int parse_message(char recvBuf[], int recvBufLen, int bytesRecv, char outBuf[], int outBufLen) 
{
    int message_index = 0;
    int message_len;
    char c;
